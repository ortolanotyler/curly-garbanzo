...
interface BlogPostPageProps {
  ...
  onBackToBlog: () => void;  // back to /blog index
  onViewJobs: () => void;
}
...
const BlogPostPage: React.FC<BlogPostPageProps> = ({ slug, onBack, onBackToBlog, onViewJobs }) => {
          ...
          <div className="mt-16 pt-10 border-t border-white/10">
            <div className="bg-white/[0.03] border border-white/5 rounded-sm p-8 md:p-10">
              <h3 className="text-xl md:text-2xl font-medium tracking-tight">
                Hiring for a key seat?
              </h3>
              <p className="mt-3 text-white/55 font-light leading-relaxed max-w-lg">
                We run finance, HR, sales, and executive searches for corporate clients across
                North America.
              </p>

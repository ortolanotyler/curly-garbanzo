...
const JobDetailDrawer: React.FC<JobDetailDrawerProps> = ({ job, isOpen, onClose, loading = false }) => {
            ...
            <div className="flex-grow overflow-y-auto custom-scrollbar">
                {loading ? (
                    <div className="p-8 space-y-10 animate-pulse">
                        <div className="h-6 w-1/3 bg-white/5 rounded-sm"></div>
                        ...
                        <div className="p-8 space-y-10">
                            ...
                            {job?.description ? (
                                <section>
                                    ...
                                    <div className="prose prose-invert prose-sm max-w-none text-gray-400 font-light">

...
const BlogPage: React.FC<BlogPageProps> = ({ onBack, onOpenPost }) => {
  ...
  return (
    <div className="min-h-screen bg-brand-dark text-white flex flex-col font-sans">
      <SEO
        title="Insights"
        description="Hiring insight and market commentary from Certus Corporate Search — executive search across finance, HR, sales, and leadership in North America."
        keywords="recruitment blog, executive search insights, hiring advice, finance hiring, HR hiring, sales hiring, leadership recruitment"
      />
      ...
      <main className="flex-grow w-full">
        ...
        <div className="max-w-5xl mx-auto px-6 lg:px-8 pt-16 md:pt-24 pb-12 md:pb-16">
          ...
          <h1 className="mt-4 text-4xl md:text-6xl font-medium tracking-tight leading-[1.05]">
            Notes on hiring &amp; talent
          </h1>
          <p className="mt-5 max-w-xl text-white/50 text-base md:text-lg font-light leading-relaxed">
            Practical perspective on executive search, hiring strategy, and the talent market
            across finance, HR, sales, and leadership.
          </p>
        </div>
